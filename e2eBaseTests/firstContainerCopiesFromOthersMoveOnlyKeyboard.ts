...
async function firstContainerCopiesFromOthersMoveOnlyKeyboard (
  page: Page,
  url: string,
  ...
  // move square 2b
  // drag overlay put us back to starting element after copy
  // 1-B
  await page.keyboard.press('Tab')
  // 1-C
  await page.keyboard.press('Tab')
...
export default firstContainerCopiesFromOthersMoveOnlyKeyboard
